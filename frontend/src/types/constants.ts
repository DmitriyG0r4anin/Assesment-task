...
export type AirMetricKey = (typeof AIR_METRIC_DATA_KEYS)[keyof typeof AIR_METRIC_DATA_KEYS];
...
/** Stable React keys for dashboard skeleton placeholders. */
export const SKELETON_PILL_IDS = ['pill-a', 'pill-b', 'pill-c', 'pill-d', 'pill-e'] as const;

export const SKELETON_ROOM_CARD_IDS = ['room-a', 'room-b', 'room-c', 'room-d', 'room-e', 'room-f'] as const;

export const SKELETON_ROOM_STAT_IDS = [
    'stat-co2',
    'stat-pm25',
    'stat-humidity',
    'stat-energy',
...
export const SKELETON_TABLE_HEADER_IDS = ['col-room', 'col-time', 'col-pm25', 'col-co2', 'col-humidity'] as const;
